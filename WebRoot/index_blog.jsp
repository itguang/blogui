...
<div class="row clearfix">
 <div class="col-md-12 column">
  <div class="jumbotron well">
   <h2 >
    <a href="article.html" target="_blank" style="text-decoration: none;" >helloworld</a>
  ...
  <span class="glyphicon glyphicon-user"></span> <a href="article.html" target="_blank" style="text-decoration: none; color: black">itguang&nbsp;</a>
  <!-- </button> -->
